    ...
    if (status == 1) {
        if (cm.getPlayer().isGroup()) {
            if (cm.getPlayer().isLeader()) {
                ...
                text += "#L0# #rReborns: 0 Tier: 100#k - Price: #b" + (1) + " " + itemName + "#k#l\r\n";
                text += "#L1# #rReborns: 10 Tier: 200#k - Price: #b" + (1) + " " + itemName + "#k#l\r\n";
                text += "#L2# #rReborns: 20 Tier: 250#k - Price: #b" + (2) + " " + itemName + "#k#l\r\n";
                text += "#L3# #rReborns: 30 Tier: 300#k - Price: #b" + (5) + " " + itemName + "#k#l\r\n";
                text += "#L4# #rReborns: 40 Tier: 400#k - Price: #b" + (10) + " " + itemName + "#k#l\r\n";
    ...
    if (status == 2) {
        ...
        if (em != null) {
            ...
            if (cm.haveItem(item, cookies)) {
                if (em.getEligiblePartyAchReborn(cm.getPlayer(), 9000, ach, 1, 4, reborns)) {
