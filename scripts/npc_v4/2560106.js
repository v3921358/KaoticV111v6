    ...
    if (status == 1) {
        if (cm.getPlayer().isGroup()) {
            if (cm.getPlayer().isLeader()) {
                ...
                text += "#L1# #rReborns: 0 Tier: 200#k - Price: #b" + (1) + " " + itemName + "#k#l\r\n";
                text += "#L2# #rReborns: 5 Tier: 250#k - Price: #b" + (2) + " " + itemName + "#k#l\r\n";
                text += "#L3# #rReborns: 10 Tier: 300#k - Price: #b" + (5) + " " + itemName + "#k#l\r\n";
                text += "#L4# #rReborns: 25 Tier: 400#k - Price: #b" + (10) + " " + itemName + "#k#l\r\n";
                text += "#L5# #rReborns: 50 Tier: 500#k - Price: #b" + (25) + " " + itemName + "#k#l\r\n";
                text += "#L6# #rReborns: 75 Tier: 750#k - Price: #b" + (50) + " " + itemName + "#k#l\r\n";
                text += "#L7# #rReborns: 90 Tier: 900#k - Price: #b" + (100) + " " + itemName + "#k#l\r\n";
    ...
    if (status == 2) {
        ...
        if (em != null) {
            ...
            if (cm.haveItem(item, cookies)) {
                if (em.getEligiblePartyAchReborn(cm.getPlayer(), 9000, ach, 4, 20, reborns)) {
