...
function start() {
    if (cm.getPlayer().getAchievement(155)) {
        cm.sendSimpleS("#L2##bExchange Reward Tickets for Glory Coins#k#l\r\n", 16);
    } else {
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        ...
        if (option == 2) {
            ...
            selStr += ("   #L12##b#i4420013# - (" + cm.getItemName(etc) + "s: #i" + etc + "# (x3))#k#l\r\n");
            selStr += ("   #L13##b#i4420014# - (" + cm.getItemName(etc) + "s: #i" + etc + "# (x4))#k#l\r\n");
            selStr += ("   #L14##b#i4420015# - (" + cm.getItemName(etc) + "s: #i" + etc + "# (x5))#k#l\r\n");
