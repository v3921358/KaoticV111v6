    ...
    if (cm.getPlayer().getParty() != null) {
        if (cm.getPlayer().isLeader()) {
            if (cm.getPlayer().getTotalLevel() >= level) {
                cm.sendSimple("Welcome to the Deepest part of the maze. Pick which necro boss to challenge.\r\n\r\n#L0# Lotus - Requires x#r100#k #i4031699# (#b" + cm.convertNumber(cm.getPlayer().countAllItem(4031699)) + "#k)#l\r\n\#L1# Damien - Requires x#r100#k #i4031700#(#b" + cm.convertNumber(cm.getPlayer().countAllItem(4031700)) + "#k)#l");
            } else {
    ...
    if (status == 1) {
        ...
        if (option == 0) {
            if (cm.haveItem(4031699, 100)) {
                ...
                cm.sendOk("You must have 100 #i4031699# in your inventory to enter here.");
            }
        } else if (option == 1) {
            if (cm.haveItem(4031700, 100)) {
                ...
                cm.sendOk("You must have 100 #i4031700# in your inventory to enter here.");
            }
        }
    }
}