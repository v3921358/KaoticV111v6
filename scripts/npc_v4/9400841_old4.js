...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "Welcome to #rVOTING#k Kaotic Slot Machine. Every single spin rewards items, match 2 symbols and whin extra amount. Match 3 Symbols win a jackpot for that item.\r\nWhich option would you like to pick from?\r\n";
        selStr += "#L1#What items does slots give?#l\r\n";
        selStr += "#L2#I want to spin some slots? (#bPrice: 10 VP#k)#l\r\n";
        ...
        rounds = Number(cm.getText());
        if (rounds > 0 && rounds <= 250) {
            if (cm.haveItem(cube, (rounds * 5))) {
                cm.sendYesNo("Are sure that you want to spend " + (rounds * 5) + " #i" + cube + "# on " + rounds + " slot spins?\r\n\How many spins would like you like to buy.\r\n\#rIF YOU DO NOT HAVE ENOUGH SPACE TO HOLD THE ITEMS,\r\n\THEY WILL BE LOST#k");
            } else {
