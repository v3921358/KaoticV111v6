...
var tier = 0;
var cost = 0;
var items = new Array(4310500, 4310504);
var amount = new Array(100, 1);

function start() {
    var selStr = "You can buy this very overpowered Golden Heart for Crypto Points. #rNo refunds will accepted for bad rolls!#k\r\n";
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        if (cm.canHold(reward)) {
            ...
            text += "    #fUI/UIWindow2.img/CTF/MinimapIcon/ItemRespawn##b " + (10000 * tier) + ": Str-Dex-Int-Luk#k\r\n";
            text += "    #fUI/UIWindow2.img/CTF/MinimapIcon/ItemRespawn##b " + (5000 * tier) + ": Atk-Matk#k\r\n";
            text += "    #fUI/UIWindow2.img/CTF/MinimapIcon/ItemRespawn##b " + (25000 * tier) + ": Def-Mdef#k\r\n";
    ...
    if (status == 3) {
        if (cm.haveItem(items[0], amount[0] * tier) && cm.haveItem(items[1], amount[1] * tier)) {
