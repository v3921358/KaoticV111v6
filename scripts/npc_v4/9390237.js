...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayer().getMapId() == 865000000) {
            option = 1;
            if (cm.getPlayer().achievementFinished(406) && cm.getPlayer().achievementFinished(407)) {
                ...
                cm.sendOk("Seems like you still have stuff to clear here before going to Arboren.\r\n\#rNeed to defeat both Riverson and Capo#k.");
            }
        } else {
            option = 2;
