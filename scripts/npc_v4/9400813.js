...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        ...
        if (skin.getAmount() > 0) {
            selStr += star + "Bonus Stats: #b+" + (skin.getAmount() * skin.getSoftMaxLevel())  + "% " + stat[skin.getStat()] + "#k (#rMax Level#k)\r\n";
        }
        if (skin.getAmount2() > 0) {
            selStr += star + "Bonus Stats: #b+" + (skin.getAmount2() * skin.getSoftMaxLevel()) + "% " + stat[skin.getStat2()] + "#k (#rMax Level#k)\r\n";
        }
        if (skin.getAmount3() > 0) {
            selStr += star + "Bonus Stats: #b+" + (skin.getAmount3() * skin.getSoftMaxLevel()) + "% " + stat[skin.getStat3()] + "#k (#rMax Level#k)\r\n";
        }
        /*
