    ...
    if (status == 1) {
        if (cm.getPlayer().isGroup()) {
            if (cm.getPlayer().isLeader()) {
                ...
                text += "#L1# #rLevel: 9000 Tier: 200#k - Price: #b" + (1 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L2# #rLevel: 9250 Tier: 210#k - Price: #b" + (5 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L3# #rLevel: 9500 Tier: 225#k - Price: #b" + (10 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L4# #rLevel: 9750 Tier: 240#k - Price: #b" + (25 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L5# #rLevel: 9999 Tier: 250#k - Price: #b" + (100 * multi) + " " + itemName + "#k#l\r\n";
    ...
    if (status == 2) {
        ...
        if (em != null) {
            ...
            if (cm.haveItem(item, cookies)) {
                if (em.getEligiblePartyAch(cm.getPlayer(), level, ach, 1, 20)) {
