...
var cube = 4310500;
var price = 1;
var items = new Array(4310015, 4310020, 2583007, 2585005, 2586002, 2587001, 2340000, 2049305, 2049189, 4001895, 5220020, 4032521, 4001760, 4310260, 4430003, 4000313, 2430131, 2000012);
var amount =   new Array(    5,    10,    5,   5,   10,   5,   1,   10,  10,  100,   1,  1,   10,   10,   1,    10,    5,   1);
var amounts =  new Array(  100,   250,   25,  10,   25,  10,  10,   25,  25, 1000,   5,  5,   50,   50,   5,   100,   25,  10);
var amountss = new Array(25000, 50000, 1000, 250, 1000, 250, 500, 1000,1000,50000, 250, 25, 2500, 5000, 250, 10000, 1000, 250);
var option = 0;
var rounds = 0;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "Welcome to Kaotic Slot Machine. Every single spin rewards items, match 2 symbols and whin extra amount. Match 3 Symbols win a jackpot for that item.\r\nWhich option would you like to pick from?\r\n";
        selStr += "#L1#What items does slots give?#l\r\n";
        selStr += "#L2#I want to spin some slots? (#bPrice: " + price + " - #i" + cube + "##k)#l\r\n";
