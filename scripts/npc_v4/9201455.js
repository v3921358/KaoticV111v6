        ...
        if (cm.haveItem(cube, 1)) {
            ...
            if (equiplist.size() >= 2) {
                ...
                for (var i = 0; i < equiplist.size(); i++) {
                    ...
                    var medal = Math.floor(curEquip.getItemId() / 10000);
                    if (curEquip != null && medal == 114) {
                        count += 1;
                        selStr += "#L" + i + "##i" + curEquip.getItemId() + "# " + cm.getItemName(curEquip.getItemId()) + "#l\r\n\ ";
                    }
                }
                if (count > 0) {
                    cm.sendSimple("Which Medal would you like to transmog?\r\n\ " + selStr);
                } else {
                    cm.sendOk("You currently do not have any Medals to transmog.");
                }
            } else {
                cm.sendOk("You currently do not have enough Medals to transmog.");
            }
        } else {
