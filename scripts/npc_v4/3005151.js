        ...
        if (amount == password) {
            if (cm.getPlayer().isGroup()) {
                if (cm.getPlayer().isLeader()) {
                    ...
                    text += "#L2# #rLevel: 6000 Tier: 125#k - Price: #b" + (5 * multi) + " " + itemName + "#k#l\r\n";
                    text += "#L3# #rLevel: 7000 Tier: 150#k - Price: #b" + (25 * multi) + " " + itemName + "#k#l\r\n";
                    text += "#L4# #rLevel: 8000 Tier: 200#k - Price: #b" + (100 * multi) + " " + itemName + "#k#l\r\n";
