    ...
    if (status == 1) {
        if (cm.getPlayer().isGroup()) {
            if (cm.getPlayer().isLeader()) {
                ...
                text += "#L1# #rLevel: 6000 Tier: 100#k - Price: #b" + (5 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L2# #rLevel: 7000 Tier: 125#k - Price: #b" + (10 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L3# #rLevel: 8000 Tier: 150#k - Price: #b" + (25 * multi) + " " + itemName + "#k#l\r\n";
