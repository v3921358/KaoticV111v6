 ...
 */
var status = 0;
var items = new Array(4009205, 4009206, 4009207, 4009208, 4009210);
var amount = new Array(250000, 250000, 250000, 250000, 2500);
var reward = 4310100;
var rewamount = 7500;
var exp = 250000;
var questid = 723;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.haveItem(items[0], amount[0]) && cm.haveItem(items[1], amount[1]) && cm.haveItem(items[2], amount[2]) && cm.haveItem(items[3], amount[3]) && cm.haveItem(items[4], amount[4])) {
