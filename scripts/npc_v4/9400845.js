...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "\r\n";
            text += "#L6##bWhat are uses of Infinity Magic Pots#k (#rVersion: 2#k)#l\r\n";
            text += "#L7##bActivate Infinity Pots#k#l\r\n";
            if (ipot > 0) {
                text += "#L8##bClaim Infinity Rewards#k (#rVersion: 2#k)#l\r\n";
            }
            cm.sendSimple(text);
        } else if (status == 1) {
            if (selection == 3) {
            ...
            if (selection == 6) {
                ...
                text += "#i4310500##i4036518##i4310502##i4310504##i4310338#\r\n";
                text += "" + star + "#b250000x#k " + cm.getItemName(4310500) + "\r\n";//gml
                text += "" + star + "#b10000x#k " + cm.getItemName(4036518) + "\r\n";//gml
                text += "" + star + "#b2500x#k " + cm.getItemName(4310502) + "\r\n";//gml
                text += "" + star + "#b25x#k " + cm.getItemName(4310504) + "\r\n";//gml
                text += "" + star + "#b1x#k " + cm.getItemName(4310338) + "\r\n";//gml
            ...
            if (option == 4) {
                ...
                text += "" + star + "#b" + (10000 * ipots) + "#k " + cm.getItemName(4036518) + "'s\r\n";//gml
                text += "" + star + "#b" + (2500 * ipots) + "#k " + cm.getItemName(4310502) + "'s\r\n";//gml
                text += "" + star + "#b" + (25 * ipots) + "#k " + cm.getItemName(4310504) + "'s\r\n";//gml
                text += "" + star + "#b" + (ipots) + "#k " + cm.getItemName(4310338) + "'s\r\n";//gml
                ...
                cm.getPlayer().addOverflow(4036518, 10000 * ipots, "collected from Infinity Rewards");
                cm.getPlayer().addOverflow(4310502, 2500 * ipots, "collected from Infinity Rewards");
                cm.getPlayer().addOverflow(4310504, 25 * ipots, "collected from Infinity Rewards");
                cm.getPlayer().addOverflow(4310338, ipots, "collected from Infinity Rewards");
