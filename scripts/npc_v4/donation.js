    ...
    if (status == 0) {
        ...
        if (selection < 99) {
            ...
            if (ach == 13) {
                ...
                selStr += "     " + star + "Jobs not on this list are vanilla GMS.\r\n";
                selStr += star + "#b#eKain (Cygnus Warrior):#k#n\r\n";
                selStr += "     " + star + "Requires Level 250+ #rWarrior Type#k to unlock this job. Does not have 4th job.\r\n\r\n";
                selStr += star + "#b#eKanna (Cygnus Mage):#k#n\r\n";
                selStr += "     " + star + "Requires Level 250+ #rMage Type#k to unlock this job. Does not have 4th job.\r\n\r\n";
                selStr += star + "#b#ePath Finder (Cygnus bowman):#k#n\r\n";
                selStr += "     " + star + "Requires Level 250+ #rBowman Type#k to unlock this job. Does not have 4th job.\r\n\r\n";
                selStr += star + "#b#eNight Walker (Cygnus Thief):#k#n\r\n";
                selStr += "     " + star + "Requires Level 250+ #rThief Type#k to unlock this job. Does not have 4th job.\r\n\r\n";
                selStr += star + "#b#eArk (Cygnus Pirate):#k#n\r\n";
                selStr += "     " + star + "Requires Level 250+ #rPirate Type#k to unlock this job. Does not have 4th job.\r\n\r\n";
                selStr += star + "#b#eGrand Master (GM):#k#n\r\n";
                selStr += "     " + star + "Very difficult job. Does not have 2-4th job. Gains 1 SP per level. No SP gain from Energy Charges. Uses all equips. Gains Base skills every level at random. Uses All stats for damage.\r\n\r\n";
            }
            if (ach == 14) {
