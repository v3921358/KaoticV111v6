...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.haveItem(cube, cost)) {
            cm.sendYesNoS("Would you like to upgrade\r\n#i" + equip.getItemId() + "# " + cm.getItemName(equip.getItemId()) + " to #bTier " + (equip.getPower() + 1) + "#k? The Price is " + cost + " #i4036084#", 16);
        } else {
        ...
        if (cm.haveItem(cube, cost)) {
            ...
            cm.sendOkS("You currently do not have enough #i4036084#. Requires " + cube + "#s", 16);
