...
var amount = 0;
function start() {
    cm.sendYesNo("Would you like to exchange 1000 #i" + etc + "# for 1 #i" + key + "#.");
}
        ...
        if (amount > 0 && amount <= 1000) {
            if (cm.haveItem(etc, 1000 * amount)) {
                if (cm.canHold(key)) {
                    ...
                    cm.sendOk("Enjoy your fishing trip.");
                ...
                cm.sendOk("Please bring me " + (1000 * amount) + " #i" + etc + "# to craft the #i" + key + "#.");
            }
        } else {
            cm.sendOk("enter a number greater than 0 and less than 1000.");
        }
