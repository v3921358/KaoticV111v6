...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cost = parseInt(Math.pow(equip.getPower(), 1.25));
        ...
        if (cost > 0 && cm.haveItem(cube, cost)) {
            if (equip != null) {
                ...
                cost = parseInt(Math.pow(equip.getPower(), 1.25));
                if (cost > 0 && cm.haveItem(cube, cost) && equip.getPower() < 250) {
