...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "";
        text += "#L1# #i2586000# = #bRandom Bonus Stats: +1% #k#l\r\n";
        text += "#L2# #i2586001# = #bRandom Bonus Stats: +2% #k#l\r\n";
        text += "#L3# #i2586002# = #bRandom Bonus Stats: +3% #k#l\r\n";
        text += "#L4# #i2586003# = #bRandom Bonus Stats: +4% #k#l\r\n";
        text += "#L5# #i2586004# = #bRandom Bonus Stats: +5% #k#l\r\n";
        text += "#L6# #i2586005# = #bRandom Bonus Stats: +10% #k#l\r\n ";
