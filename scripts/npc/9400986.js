        ...
        if (status == 0) {
            if (cm.haveItem(ticketId, 5)) {
                if (cm.getPlayer().getInventory(Packages.client.inventory.MapleInventoryType.SETUP).getNumFreeSlot() >= 1) {
                    ...
                    cm.sendSimple("Which Chair would you like to buy for 5 #i" + ticketId + "# " + cm.getItemName(ticketId) + "?\r\n\ " + selStr);
                } else {
                    cm.sendOk("You currently do not have 1 or more Equip slots free.");

                }
            } else {
                cm.sendOk("You currently do not have 5 or more #i" + ticketId + "# " + cm.getItemName(ticketId) + " for Chair of choice.");
            ...
            if (cm.haveItem(ticketId, 5)) {
                ...
                cm.gainItem(equip, 1);
                cm.sendOk("You have successfully exchanged 5 #i" + ticketId + "# " + cm.getItemName(ticketId) + " for #i" + equip + "#.\r\n\ If chair appears invisible do not drop or trade it, save it and report the item to resinate.");
            } else {
                cm.sendOk("You currently do not have 5 or more #i" + ticketId + "# " + cm.getItemName(ticketId) + " for Chair of choice.");
