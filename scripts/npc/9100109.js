...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        scale = cm.getPlayer().getTotalLevel() * 0.01;
        cm.sendSimple("Welcome to the Mega Gachapon (#bTier#k: #r1-5#k). How may I help you?\r\n#bTickets can be found by completing Tutorial Dungeons.#k\r\n\r\n#L5#Cash in #i5220000#?#l\r\n#L4#What are the rewards in this Gold Gachapon?#l");
    } else if (status == 1) {
        if (selection == 4) {
        ...
        if (selection == 5) {
            ...
            if (cm.haveItem(ticketId, 1)) {
                ...
                option = 2;
                cm.sendOk("You don't have enough #i5220000#. You can find these by Talking to Dame or finding them extremely rare from monsters.");
        ...
        if (cm.haveItem(ticketId, amount) && amount > 0) {
            ...
            // var rewards = cm.getRewardsByPower2(9110100, cm.getPlayer(), 1, 5);
            var rewards = cm.getRewards(9110100, cm.getPlayer(), 1, cm.random(1, 5));
            if (rewards == null) {
            ...
            cm.sendOk("You don't have enough #i5220000#. You can find these by Talking to Dame.");
