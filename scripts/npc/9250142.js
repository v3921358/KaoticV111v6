        ...
        if (amount == password) {
            if (cm.getPlayer().isGroup()) {
                if (cm.getPlayer().isLeader()) {
                    ...
                    text += "#L1# #rLevel 9000 Tier: 100#k - Price: #b" + (1) + " " + itemName + "#k#l\r\n";
                    text += "#L2# #rLevel 9200 Tier: 125#k - Price: #b" + (2) + " " + itemName + "#k#l\r\n";
                    text += "#L3# #rLevel 9400 Tier: 150#k - Price: #b" + (3) + " " + itemName + "#k#l\r\n";
                    text += "#L4# #rLevel 9600 Tier: 200#k - Price: #b" + (4) + " " + itemName + "#k#l\r\n";
                    text += "#L5# #rLevel 9800 Tier: 250#k - Price: #b" + (5) + " " + itemName + "#k#l\r\n";
