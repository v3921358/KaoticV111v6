...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        if (cm.getPlayer().isGroup()) {
            if (cm.getPlayer().isLeader()) {
                ...
                text += "#L1# #rLevel: 9000 Tier: 200#k - Price: #b" + (5) + " " + itemName + "#k#l\r\n";
                text += "#L2# #rLevel: 9100 Tier: 250#k - Price: #b" + (10) + " " + itemName + "#k#l\r\n";
                text += "#L3# #rLevel: 9200 Tier: 300#k - Price: #b" + (25) + " " + itemName + "#k#l\r\n";
                text += "#L4# #rLevel: 9400 Tier: 400#k - Price: #b" + (50) + " " + itemName + "#k#l\r\n";
                text += "#L5# #rLevel: 9600 Tier: 500#k - Price: #b" + (75) + " " + itemName + "#k#l\r\n";
                text += "#L6# #rLevel: 9800 Tier: 750#k - Price: #b" + (100) + " " + itemName + "#k#l\r\n";
                text += "#L7# #rLevel: 9999 Tier: 900#k - Price: #b" + (250) + " " + itemName + "#k#l\r\n";
    ...
    if (status == 2) {
        var em = cm.getEventManager("boss_abyss");
        if (em != null) {
            var level = 9000;
            var tier = 200;
            var cookies = 5, reborns = 0;
            if (selection == 2) {
                level = 9100;
                tier = 250;
                cookies = 10;
            ...
            if (cm.haveItem(item, cookies)) {
                if (em.getEligiblePartyAchReborn(cm.getPlayer(), 9000, ach, 4, 20, 0)) {
