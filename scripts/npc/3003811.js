...
var amount = new Array(10, 5, 5, 5, 5, 5, 5, 5, 5, 5);
    ...
    if (status == 0) {
        ...
        if (option == 2) {
            ...
            if (sel >= 0 && sel < 9) {
                ...
                if (cm.haveItem(selectedItem, 1000)) {
                    selectedItemCount = Math.floor(cm.getPlayer().countAllItem(selectedItem) / 1000);
        ...
        if (selectedItemCount > 0 && cm.haveItem(selectedItem, 1000 * selectedItemCount)) {
            if (cm.canHold(selectedItemStone, selectedItemCount)) {
                cm.gainItem(selectedItem, -(1000 * selectedItemCount));
