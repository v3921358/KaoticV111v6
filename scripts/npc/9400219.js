...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var text = "\r\n";
        text += "#L2049189##i2049189# #b" + cm.getItemName(2049189) + "#k#l\r\n";
        text += "#L2049175##i2049175# #b" + cm.getItemName(2049175) + "#k#l\r\n";
        text += "#L2049176##i2049176# #b" + cm.getItemName(2049176) + "#k#l\r\n";
        text += "#L2049177##i2049177# #b" + cm.getItemName(2049177) + "#k#l\r\n";
