...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text = "";
        //text += "#L4# #i2586003# + #i4310502#   = #bRandom Bonus Stats: +5% #k#l\r\n";
        text += "#L5# #i2586004# + #i4310502#   = #bRandom Bonus Stats: +10% #k#l\r\n";
        text += "#L7# #i2586004# + #i4310504#   = #bRandom Bonus Stats: +100% #k#l\r\n";
        text += "#L9# #i2586004# + #i4310505#   = #bRandom Bonus Stats: +500% #k#l\r\n";
        text += "#L6# #i2586005# + #i4310502#   = #bRandom Bonus Stats: +25% #k#l\r\n";
        text += "#L8# #i2586005# + #i4310504#   = #bRandom Bonus Stats: +250% #k#l\r\n";
        text += "#L10# #i2586005# + #i4310505#   = #bRandom Bonus Stats: +1000% #k#l\r\n";
        text += "\r\n";
        cm.sendSimple("Welcome traveler! If you happened to stumble on some soul gems and protection, I can upgrade you gear with them.\r\n#rEach Gem Combo will consume an equip's upgrade slot!#k\r\n" + text);
    } else if (status == 1) {
        chance = 0;
        if (selection == 5) {
            chance = 5;
        ...
        if (!equiplist.isEmpty()) {
            ...
            if (count > 0) {
                ...
                cm.sendOk("You currently do not have any Equips to soul enchance.");
            }
        } else {
            cm.sendOk("You currently do not have any Equips to soul enhance.");
        }
    } else if (status == 2) {
        if (equip == null) {
            equip = equiplist.get(selection);
        }
        cm.sendGetTextS("How many #i" + cube + "#+#i" + scroll + "# would you like me to apply to this Equip?\r\n#rMax Scrolls that can be used is 9999#k", 16);
    } else if (status == 3) {
        cost = cm.getNumber();
        if (cost > 0 && cost <= 9999) {
            if (cm.haveItem(cube, cost) && cm.haveItem(scroll, cost)) {
                cm.sendYesNoS("ARe you sure you wish to apply " + cost + " #i" + cube + "#-#i" + scroll + "# to \r\n#i" + equip.getItemId() + "# " + cm.getItemName(equip.getItemId()) + "?", 16);
            } else {
                cm.sendOkS("You currently do not have enough #i" + cube + "# or #i" + scroll + "#", 16);
            }
        } else {
        ...
        if (cm.haveItem(cube, cost) && cm.haveItem(scroll, cost)) {
            if (equip != null) {
                ...
                stats += "You have consumed #b" + used + " #i" + cube + "#+#i" + scroll + "##k\r\n";
            ...
            cm.sendOk("You currently do not have enough Materials to Soul Gem. Requires #i" + cube + "# and #i" + scroll + "#");
        }
    }
}
