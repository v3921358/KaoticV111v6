                ...
                if (cm.getPlayer().isGroup()) {
                    ...
                    for (var i = 0; i < bosses.length; i++) {
                        if (cm.getPlayer().getAchievement(441)) {
                            text += "#L" + i + "##bKaotic " + bosses[i] + " - (T: " + tiers[i] + " - Reborn: " + level[i] + " Stam: " + (cost[i] * 250) + ")#k#l\r\n";
                        }
                    }
                    cm.sendSimpleS("Which #rSolo-Challenge#k would you like take on?\r\n" + text + " ", 16);
                } else {
            ...
            if (cm.getPlayer().isGroup()) {
                if (cm.getPlayer().getStamina() >= stam) {
                    ...
                    if (em != null) {
                        ...
                        if (em.getEligiblePartyAchReborn(cm.getPlayer(), 9000, 441, 1, 1, level[selection])) {
                    ...
                    cm.sendOkS("You do not have enough stamina to enter the event, the cost is #r" + stam + "#k Stamina.", 16);
                }
            } else {
