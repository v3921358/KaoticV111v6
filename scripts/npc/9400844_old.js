    ...
    if (status == 0 && mode == 1) {
        ...
        if (selection == 5) {
            ...
            if (cm.haveItem(ticketId, 5)) {
                ...
                option = 2;
                cm.sendOk("You don't have enough #i4310502#. You can find these by Talking to Dame or finding them extremely rare from monsters.");
        ...
        if (cm.haveItem(ticketId, amount) && amount > 0) {
            ...
            var rewards = cm.getRewardsByPower2(9110010, cm.getPlayer(), 1, 10);
            if (rewards == null) {
