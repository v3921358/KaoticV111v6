        ...
        if (status == 0) {
            if (cm.haveItem(ticketId, 1)) {
                if (cm.getPlayer().getInventory(Packages.client.inventory.MapleInventoryType.EQUIP).getNumFreeSlot() >= 1) {
                    cm.sendSimple("Welcome to the Item of Choice Donation Shop. Pick a category of NX you would like to purchase from?\r\n\ Warning some list takes upto 10 second load do not close npc.\r\n\I only accept 1 #i" + ticketId + "# Donation Points.\r\n\r\n#L0#Weapons?#l\r\n#L1#Hats?#l\r\n#L2#Overall?#l\r\n#L3#Top?#l\r\n#L4#Bottom?#l\r\n#L5#Gloves?#l\r\n#L6#Shield?#l\r\n#L7#Shoes?#l\r\n#L8#Cape?#l\r\n#L9#Acc?#l");
                } else {
                    cm.sendOk("You currently do not have 1 or more Equip slots free.");

                }
            } else {
                cm.sendOk("You currently do not have 1 or more Donation Points for NX of choice.");
