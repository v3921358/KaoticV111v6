...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var text = "You currently have #b" + ipot + "#k Infinity Pots Activated!\r\n";
            //text += "#L5##bWhat are uses of Supreme Magic Pots#k#l\r\n";
            //text += "#L3##bActivate Supreme Pots#k#l\r\n";
            //text += "\r\n";
            text += "#L6##bWhat are uses of #z5450200##k#l\r\n";
            text += "#L7##bActivate Infinity Pots#k#l\r\n";
            if (ipot > 0) {
                text += "#L8##bClaim Daily Infinity Rewards#k#l\r\n";
            }
            cm.sendSimple(text);
        } else if (status == 1) {
            if (selection == 3) {
            ...
            if (selection == 6) {
                ...
                text += "#i4310500##i4310506##i4310510#\r\n";
                text += "" + star + "#b100x#k #r#z4310500##k\r\n";//gmb
                text += "" + star + "#b25x#k #r#z4310506##k\r\n";//mag
                text += "" + star + "#b5x#k #r#z4310510##k\r\n";//doll
                text += "#rItems gained will be placed inside your OVERFLOW system.#k\r\n";//DP
                text += "#bNote: Rewards may be changed to match current content of the server.#k\r\n";//DP
                cm.sendOk(text);
            }
            if (selection == 7) {
                option = 3;
            ...
            if (option == 4) {
                ...
                text += "" + star + "#b" + (100 * ipots) + "#k #z4310500#'s\r\n";//gml
                text += "" + star + "#b" + (25 * ipots) + "#k #z4310506#'s\r\n";//gml
                text += "" + star + "#b" + (5 * ipots) + "#k #z4310510#'s\r\n";//gml
                text += "#rAll rewards have been sent to Overflow system (@etc-@item)#k\r\n";//gml
                text += "#bCome back tomorrow to claim more rewards.#k\r\n";//gml
                cm.getPlayer().addOverflow(4310500, 100 * ipots, "collected from Infinity Rewards");
                cm.getPlayer().addOverflow(4310506, 25 * ipots, "collected from Infinity Rewards");
                cm.getPlayer().addOverflow(4310510, 5 * ipots, "collected from Infinity Rewards");
