...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        cm.sendYesNo("Hello#b #h ##k, Would you like to change the look of your andriod to a random look for the cost of a single #i4310505#?");
    } else if (status == 1) {
        if (cm.haveItem(ticketId, 1)) {
            ...
            cm.sendOk("You don't have #i" + ticketId + "# " + cm.getItemName(ticketId) + ". You can find these by Donating.");
