...
function start() {
    var selStr = "Welcome to the #i" + gach + "# (#bHalloween#k) Damage Skins Banner:\r\n";
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        ...
        if (option == 0) {
            ...
            var selStr = "Select a Tier from #bHalloween#k Damage Skins Banner:\r\n";
            if (count_0 > 0) {
            ...
            selStr += ("   #L6##rAll Damage Skins (Not Owned)#k #l\r\n");
            cm.sendSimpleS(selStr, 16);
        }
        if (option == 1) {
            if (cm.haveItem(gach)) {
            ...
            if (!list.isEmpty()) {
                ...
                if (selection > 5) {
                    ...
                    if (count > 0) {
                        ...
                        cm.sendOkS("You have all possible damage skins obtained in this banner.", 16);
                    }
                } else {
