        ...
        if (amount == password) {
            if (cm.getPlayer().isGroup()) {
                if (cm.getPlayer().isLeader()) {
                    var text = "You better have brought my #b" + itemName + " " + cm.getItemName(item) + "s#k\r\nCurrent Amount: (#b" + cm.convertNumber(cm.getPlayer().countAllItem(item)) + "#k)\r\n#r#k\rRequired Level: 9999\n";
                    //text += "#L1# #rCash in #i" + orb + "#" + cm.getItemName(orb) + " for Fel Power!#k#l\r\n\r\n";
                    text += "#L1# #rTier: 250#k - Price: #b" + (10) + " " + itemName + "#k#l\r\n";
                    text += "#L2# #rTier: 300#k - Price: #b" + (25) + " " + itemName + "#k#l\r\n";
                    text += "#L3# #rTier: 400#k - Price: #b" + (50) + " " + itemName + "#k#l\r\n";
                    text += "#L4# #r100 Tier: 500#k - Price: #b" + (100) + " " + itemName + "#k#l\r\n";
                    text += "#L5# #r150 Tier: 600#k - Price: #b" + (150) + " " + itemName + "#k#l\r\n";
                    text += "#L6# #r200 Tier: 800#k - Price: #b" + (200) + " " + itemName + "#k#l\r\n";
                    text += "#L7# #r250 Tier: 999#k - Price: #b" + (250) + " " + itemName + "#k#l\r\n";
    ...
    if (status == 2) {
        ...
        if (em != null) {
            ...
            if (cm.haveItem(item, cookies)) {
                if (em.getEligiblePartyAchReborn(cm.getPlayer(), level, ach, 1, 1, 0)) {
