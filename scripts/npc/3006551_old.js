...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayer().getReborns() >= 10) {
            ...
            cm.sendOk("You currently do not have enough 25+ reborns to use my services.\r\n#rCurrent Reborn Count: " + cm.getPlayer().getReborns() + "#k");
        }
        ...
        if (cm.haveItem(cube, cost)) {
            ...
            cm.sendOkS("You currently do not have enough #i2049032#. Requires " + cube + "#s", 16);
