...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendNext("If you feel you are powerful enough, you can join others like you at where we are hosting the contests of power. ... So, what is your decision? Will you come to where the contests are being held right now?");
    } else if (status == 3) {
        cm.sendYesNo("Very well. Remember, there you can assemble a team or take on the fightings on your own, it's up to you. Good luck!");
    } else if (status == 4) {
