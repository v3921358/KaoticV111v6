...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        if (cm.getPlayer().isGroup()) {
            if (cm.getPlayer().isLeader()) {
                ...
                text += "#L1# #rLevel: 6000 Tier: 100#k - Price: #b" + (1 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L2# #rLevel: 7000 Tier: 150#k - Price: #b" + (2 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L3# #rLevel: 8000 Tier: 200#k - Price: #b" + (3 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L4# #rLevel: 9000 Tier: 250#k - Price: #b" + (4 * multi) + " " + itemName + "#k#l\r\n";
                text += "#L5# #rLevel: 9500 Tier: 300#k - Price: #b" + (5 * multi) + " " + itemName + "#k#l\r\n";
    ...
    if (status == 2) {
        var em = cm.getEventManager("boss_kalos");
        if (em != null) {
            var level = 6000;
            var tier = 100;
            var cookies = multi;
