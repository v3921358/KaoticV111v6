...
function setup(player, level, scale) {
    var eim = em.newInstance(player, "BMT_Asura_" + player.getName(), true);
...
function start(eim) {
    ...
    map.spawnMonsterOnGroundBelow(eim.getKaoticMonster(8900100, eim.getValue("level"), eim.getValue("scale") - 1, false, false, false), eim.newPoint(eim.getRandom(-400, 800), 750));
    map.spawnMonsterOnGroundBelow(eim.getKaoticMonster(8900101, eim.getValue("level"), eim.getValue("scale") - 2, false, false, false), eim.newPoint(eim.getRandom(-400, 800), 750));
    map.spawnMonsterOnGroundBelow(eim.getKaoticMonster(8900102, eim.getValue("level"), eim.getValue("scale") - 3, false, false, false), eim.newPoint(eim.getRandom(-400, 800), 750));
