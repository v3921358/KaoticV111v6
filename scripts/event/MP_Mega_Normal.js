...
function setup(player, level, scale) {
    ...
    eim.setIntProperty("reward", 200);
    eim.setIntProperty("exp", 200);
    eim.setIntProperty("rank", 40);
    eim.setIntProperty("baseAch", 0);
    eim.setIntProperty("ach", 0);
    eim.setIntProperty("coin", 3000);
    eim.setIntProperty("kaotic", 50);
