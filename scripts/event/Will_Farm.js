...
var entryMap = 450007350;
var exitMap = 450007200;

var minMapId = 450007350;
var maxMapId = 450007350;
var eventMapId = 450007350;
...
function setup(player, level) {
    var eim = em.newInstance(player, "Will_Farm_" + player.getName(), true);
...
function start(eim) {
    ...
    for (var i = 0; i < eim.getIntProperty("spawn"); i++) {
        map.spawnMonsterOnGroundBelow(eim.getMonster(8644510, level, 4), eim.newPoint(eim.getRandom(-1000, 1000), 150));
    }
}
