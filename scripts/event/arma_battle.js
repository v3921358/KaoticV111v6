...
var entryMap = 450001340;
var exitMap = 450001230;

var minMapId = 450001340;
var maxMapId = 450001340;
var eventMapId = 450001340;
...
function setup(player, lobbyid) {
    var eim = em.newInstance(player, "arma_battle" + player.getName(), true);
