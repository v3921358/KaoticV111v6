...
function start(eim) {
    ...
    for (var i = 1; i <= 10; i++) {
        map.spawnMonsterOnGroundBelow(eim.getKaoticMonster(8860002, level, scale - 5, false, false, false), eim.newPoint(eim.getRandom(-500, 800), 750));
    }
    for (var j = 1; j <= 5; j++) {
        map.spawnMonsterOnGroundBelow(eim.getKaoticMonster(8860001, level, scale - 2, false, false, false), eim.newPoint(eim.getRandom(-400, 700), 750));
    }
