...
function setup(player) {
    var eim = em.newInstance(player, "battle_capt_" + player.getName(), true);
    map = eim.getMapInstance(entryMap);
    map.setInstanced(true);
    //map.setSummons(false);
    eim.startEventTimer(eventTime * 60000);
    map.spawnMonsterOnGroundBelow(eim.getMonster(9480049), eim.newPoint(-135, 220));
    return eim;
}
