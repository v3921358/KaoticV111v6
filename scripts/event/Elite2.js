...
function start(eim) {
    ...
    var map = eim.getMapInstance(eventMapId);
    var mob = eim.getKaoticMonster(eim.getRandom(8220022, 8220026), eim.getIntProperty("level"), eim.getIntProperty("scale"), true, true, true, true, eim.getIntProperty("scale") * 100);
    mob.setForceBar();
