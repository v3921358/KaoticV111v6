...
var recruitMap = 410007261;
var entryMap = 410007261;
var exitMap = 410007025;

var eventMapId = 410007261;

var startMap = 410007261;
var endMap = 410007261;
...
function setup(player, mob, tier) {
    ...
    eim.setValue("level", player.getTotalLevel() * 1.25);
...
function bomb(eim) {
    if (eim.getValue("finished") == 0) {
        ...
        map.forceRespawn(mob, level, tier, false);
...
function playerEntry(eim, player) {
    ...
    eim.changeMusic("BgmLimbo/Reproduced_Abyss_D");
}
