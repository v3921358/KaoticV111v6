...
function setup(player, level, scale) {
    var eim = em.newInstance(player, "BMT_Hilla_" + player.getName(), true);
...
function start(eim) {
    ...
    eim.getMapInstance(eventMapId).spawnMonsterOnGroundBelow(eim.getMonsterNoAll(8880403, eim.getValue("level"), eim.getValue("scale") - 1), eim.newPoint(eim.getRandom(-500, 1200), 750));
    eim.getMapInstance(eventMapId).spawnMonsterOnGroundBelow(eim.getMonsterNoAll(8880404, eim.getValue("level"), eim.getValue("scale") - 1), eim.newPoint(eim.getRandom(-500, 1200), 750));
