...
function setup(player, level, scale) {
    var eim = em.newInstance(player, "BMT_Kalos_" + player.getName(), true);
...
function start(eim) {
    var mob = eim.getKaoticMonster(8880806, eim.getValue("level"), eim.getValue("scale"), true, false, true, true, 999, true, true, false, false);
