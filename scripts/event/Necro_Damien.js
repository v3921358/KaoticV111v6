...
function setup(player) {
    var eim = em.newInstance(player, "Necro_Damien_" + player.getName(), true);
...
function start(eim) {
    var nMob1 = eim.getKaoticMonster(8880404, 2000, 58, true, false, true, true, 999, true, true, false, true);
