...
function setup(player, level, scale) {
    ...
    eim.setIntProperty("reward", 150);
    eim.setIntProperty("exp", 150);
    eim.setIntProperty("rank", 30);
    eim.setIntProperty("baseAch", 0);
    eim.setIntProperty("ach", 0);
    eim.setIntProperty("coin", 2000);
    eim.setIntProperty("kaotic", 25);
