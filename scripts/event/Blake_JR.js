...
function start(eim) {
    ...
    map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410200, 999, 50, true, false, false, true, 250), 15, eim.newPoint(-425, 110));//boss_0 - cannon
    ...
    if (eim.getValue("finished") == 0) {
        if (mob.getId() == 9410200 || mob.getId() == 9410206 || mob.getId() == 9410207 || mob.getId() == 9410208 || mob.getId() == 9410209 || mob.getId() == 9410211 || mob.getId() == 9410213) {
            ...
            if (mob.getId() == 9410200) {
                ...
                map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410208, 999, 50, true, false, false, true, 250), 15, eim.newPoint(-413, 1740));//boss_3 - merc
            }
            if (mob.getId() == 9410206) {
                ...
                map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410211, 999, 50, true, false, false, true, 250), 15, eim.newPoint(242, 2560));//boss_5 - lumi
            }
            if (mob.getId() == 9410207) {
                ...
                map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410213, 999, 50, true, false, false, true, 250), 15, eim.newPoint(2218, 2560));//boss_6 - DS
            }
            if (mob.getId() == 9410208) {
                ...
                map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410206, 999, 50, true, false, false, true, 250), 15, eim.newPoint(2215, 110));//boss_1 - aran
            }
            if (mob.getId() == 9410209) {
                ...
                map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410207, 999, 50, true, false, false, true, 250), 15, eim.newPoint(-413, 925));//boss_2 - evan
            }
            if (mob.getId() == 9410211) {
                ...
                map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410209, 999, 50, true, false, false, true, 250), 15, eim.newPoint(2222, 1740));//boss_4 - phantom
            }
            if (mob.getId() == 9410213) {
                ...
                map.spawnMonsterWithEffectBelow(eim.getKaoticMonster(9410210, 999, 50, true, false, true, true, 2500), 15, eim.newPoint(900, 1810));
