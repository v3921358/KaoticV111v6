...
function setup(player, level, scale) {
    var eim = em.newInstance(player, "MP_Easy_" + scale + "_" + player.getName(), true);
    ...
    eim.setValue("exp", 5);
    eim.setValue("rank", 1);
    eim.setValue("baseAch", 200);
    eim.setValue("ach", scale);
    eim.setValue("coin", 1);
    eim.setValue("ticket", 4001514);
    eim.setValue("rock", 4260000);
