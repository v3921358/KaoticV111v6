...
function setup(player, level, tier) {
    ...
    //trash
    var white = eim.getRandom(1, 4);
    var color = eim.getRandom(0, 3);
    var rand_trash = 8899001;
    var rand_boss = 8899000;
    var hits = 999;
    var bhits = 9999;
...
function monsterKilled(mob, eim) {
    if (mob.getId() == 8899006 || mob.getId() == 8899007 || mob.getId() == 8899008 || mob.getId() == 8899009 || mob.getId() == 8899000) {
        eim.setValue("finished", 1);
        eim.victory(exitMap);
    }
}
