...
function setup(player, level, scale) {
    var eim = em.newInstance(player, "MP_Hard_" + scale + "_" + player.getName(), true);
    eim.setValue("scale", 3);
    ...
    eim.setValue("exp", 15);
    eim.setValue("rank", 1);
    eim.setValue("baseAch", 220);
    eim.setValue("ach", scale);
    eim.setValue("coin", 3);
    eim.setValue("ticket", 4001522);
    eim.setValue("rock", 4260006);
