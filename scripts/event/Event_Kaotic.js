...
function start(eim) {
    ...
    eim.broadcastPlayerMsg(5, "You have 10 mins to kill as many shadow monsters as you can. Monsters - Kaotic Tier " + scale + " - Starting Level: " + level);
    ...
    if (!eim.isDisposed()) {
        ...
        if (map.getSpawnedMonstersOnMap() < eim.getValue("spawn")) {
            ...
            for (var i = 0; i < spawncount; i++) {
                var mob = eim.getKaoticMonster(eim.getRandom(8230062, 8230068), level, scale, false, false, false, true);
                mob.setAggro(true);
