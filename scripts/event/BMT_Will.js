...
function setup(player, level, scale) {
    var eim = em.newInstance(player, "BMT_Will_" + player.getName(), true);
...
function start(eim) {
    ...
    var mob = eim.getKaoticMonster(8880302, eim.getValue("level"), eim.getValue("scale"), true, false, true, true, 999, true, true, false, false);
    eim.getMapInstance(eventMapId).spawnMonsterOnGroundBelow(mob, eim.newPoint(330, 750));
    eim.getMapInstance(eventMapId).spawnMonsterOnGroundBelow(eim.getMonsterNoAll(8880306, eim.getValue("level"), eim.getValue("scale") - 1), eim.newPoint(eim.getRandom(-250, 250), 750));
