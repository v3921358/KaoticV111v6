...
function setup(player) {
    var eim = em.newInstance(player, "ShowaBattle_" + player.getName(), true);
    //eim.createInstanceMap(220080001);
    eim.startEventTimer(eventTime * 60000);
    eim.getMapInstance(entryMap).setInstanced(true);
    eim.getMapInstance(entryMap).spawnMap();
    var nMob = eim.getKaoticMonster(9400300, 150, 7, true, false, true, true, 99, true, false, false, true);
    eim.spawnMonsterOnGroundBelow(eventMapId, nMob, eim.newPoint(400, 160));
    return eim;
}
