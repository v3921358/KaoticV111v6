...
function enter(pi) {
    var em = pi.getEventManager("boss_riverson");
    if (em != null) {
        if (pi.getPlayer().getStamina() >= 50) {
            ...
            pi.playerMessage(1, "You do not have enough stamina to enter the event, the cost is 50 Stamina.");
        }
    } else {
