...
function enter(pi) {
	...
	if (pi.getPlayer().getMapId() == 240070202) {
		em = pi.getEventManager("TD_Battle1");
	}
		if (pi.getPlayer().getMapId() == 240070302) {
		em = pi.getEventManager("TD_Battle2");
	}
		if (pi.getPlayer().getMapId() == 240070402) {
		em = pi.getEventManager("TD_Battle3");
	}
		if (pi.getPlayer().getMapId() == 240070502) {
		em = pi.getEventManager("TD_Battle4");
	}
		if (pi.getPlayer().getMapId() == 240070602) {
		em = pi.getEventManager("TD_Battle5");
	}
