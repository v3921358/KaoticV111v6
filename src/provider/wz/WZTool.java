...
public class WZTool {
    ...
    public static String readDecodedString(SeekableLittleEndianAccessor llea) {
        int strLength;
    ...
    public static int readValue(SeekableLittleEndianAccessor lea) {
        byte b = lea.readByte();
        if (b == -128) {
            return lea.readInt();
        } else {
    ...
    public static float readFloatValue(SeekableLittleEndianAccessor lea) {
        byte b = lea.readByte();
        if (b == -128) {
