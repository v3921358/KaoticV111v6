 ...
 * @author RonanLana
 *
 * This tool has the main purpose of auditing deadlocks throughout the server
 * and must be used only for debugging. The flag is USE_THREAD_TRACKER.
 */
public class ThreadTracker {
    ...
    public void registerThreadTrackerTask() {
        threadTrackerSchedule = TimerManager.getInstance().register(() -> {
