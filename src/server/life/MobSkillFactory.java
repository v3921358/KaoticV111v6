...
public class MobSkillFactory {
	...
	return getInstance().mobSkillCache.get(new Pair<Integer, Integer>(Integer.valueOf(skillId), Integer.valueOf(level)));
    }

    private void initialize() {
        try (Connection con = DatabaseConnection.getWorldConnection(); PreparedStatement ps = con.prepareStatement("SELECT * FROM wz_mobskilldata"); ResultSet rs = ps.executeQuery()) {
            while (rs.next()) {
