...
public class MapScriptMethods {
            ...
            case shammos_Fenter: {
                if (c.getPlayer().getMapId() >= (GameConstants.GMS ? 921120100 : 921120005) && c.getPlayer().getMapId() < (GameConstants.GMS ? 921120300 : 921120500)) {
                    ...
                    if (c.getPlayer().getEventInstance() != null) {
                        ...
                        averageLevel /= size;
                        shammos.changeLevel(averageLevel, shammos.getStats().getScale(), true);
                        c.getPlayer().getEventInstance().registerMonster(shammos);
                    ...
                    shammos.updateMonsterController();
                    c.announce(MobPacket.getNodeProperties(shammos, c.getPlayer().getMap()));

                    /*} else if (c.getPlayer().getMapId() == (GameConstants.GMS ? 921120300 : 921120500) && c.getPlayer().getMap().getAllMonsters().size() == 0) {
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case StageMsg_crack:
                if (c.getPlayer().getMapId() == 922010400) { //2nd stage
                    MapleMapManager mf = c.getChannelServer().getMapFactory();
                    int q = 0;
                    for (int i = 0; i < 5; i++) {
                        q += mf.getMap(922010401 + i).getAllMonsters().size();
                    }
                    if (q > 0) {
            ...
            case go1010300:
            case go1010400: {
                c.announce(CField.MapNameDisplay(c.getPlayer().getMapId()));
                break;
            }
            case ds_tuto_ill0: {
            ...
            case ds_tuto_home_before: {
                ...
                c.announce(CField.showEffect("demonSlayer/text11"));
            ...
            case ds_tuto_3_0: {
                ...
                c.announce(UIPacket.getDirectionInfo(1, 30));
                c.announce(UIPacket.getDirectionStatus(true));
                c.announce(CField.showEffect("demonSlayer/text12"));
            ...
            case ds_tuto_2_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.announce(UIPacket.getDirectionInfo(3, 0));
                        c.announce(CField.showEffect("demonSlayer/text13"));
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.announce(CField.showEffect("demonSlayer/text14"));
                        c.announce(UIPacket.getDirectionInfo(1, 4000));
                    }
                }, 1500);
                EventTimer.getInstance().schedule(new Runnable() {
            ...
            case ds_tuto_1_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.announce(UIPacket.getDirectionInfo(3, 0));
                        c.announce(CField.showEffect("demonSlayer/text8"));
                        c.announce(UIPacket.getDirectionInfo(1, 500));
                    }
                }, 1000);
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.announce(CField.showEffect("demonSlayer/text9"));
            ...
            case ds_tuto_0_0: {
                ...
                c.getPlayer().changeSkillsLevel(sa);
                c.announce(UIPacket.getDirectionInfo(3, 0));
                c.announce(CField.showEffect("demonSlayer/back"));
                c.announce(CField.showEffect("demonSlayer/text0"));
                c.announce(UIPacket.getDirectionInfo(1, 500));
                c.getPlayer().setDirection(0);
    ...
    private static void sendDojoStart(MapleClient c, int stage) {
        c.announce(CField.environmentChange("Dojang/start", 4));
        c.announce(CField.environmentChange("dojang/start/stage", 3));
        c.announce(CField.environmentChange("dojang/start/number/" + stage, 3));
                ...
                for (String s : di.eventQ) {
                    switch (directionInfo.fromString(s)) {
                        ...
                        case merTutorDrecotion21:
                            ...
                            break;
                        case ds_tuto_0_2:
                            c.announce(CField.showEffect("demonSlayer/text1"));
                            break;
                        case ds_tuto_0_1:
                            c.announce(UIPacket.getDirectionInfo(3, 2));
                            break;
                        case ds_tuto_0_3:
                            c.announce(CField.showEffect("demonSlayer/text2"));
                            EventTimer.getInstance().schedule(new Runnable() {

                                public void run() {
                                    c.announce(UIPacket.getDirectionInfo(1, 4000));
                                    c.announce(CField.showEffect("demonSlayer/text3"));
                                }
                            }, 2000);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.announce(UIPacket.getDirectionInfo(1, 500));
                                    c.announce(CField.showEffect("demonSlayer/text4"));
                                }
                            }, 6000);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.announce(UIPacket.getDirectionInfo(1, 4000));
                                    c.announce(CField.showEffect("demonSlayer/text5"));
                                }
                            }, 6500);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.announce(UIPacket.getDirectionInfo(1, 500));
                                    c.announce(CField.showEffect("demonSlayer/text6"));
                                }
                            }, 10500);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.announce(UIPacket.getDirectionInfo(1, 4000));
                                    c.announce(CField.showEffect("demonSlayer/text7"));
                                }
                            }, 11000);
                            EventTimer.getInstance().schedule(new Runnable() {
