...
public class MapleMist extends MapleMapObject {
    ...
    public void remove(MapleMap map) {
        map.broadcastMessage(CField.removeMist(getObjectId(), false));
        map.removeMapObject(this, MapleMapObjectType.MIST);
