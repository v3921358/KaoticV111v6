...
public class PlayerShopPacket {
    ...
    public static final byte[] getPlayerStore(final MapleCharacter chr, final boolean firstTime) {
        ...
        mplew.write(4);
        mplew.write(7);
        mplew.write(ips.isOwner(chr) ? 0 : ips.getVisitorSlot(chr));
        mplew.write(0);
        ...
        for (final MaplePlayerShopItem item : ips.getItems()) {
            //System.out.println("shop bundles: " + item.bundles);
            mplew.writeShort(item.amount);
            mplew.writeShort(item.bundles);
            mplew.writeInt(item.price);
            PacketHelper.addItemInfo(mplew, item.item);
        ...
        mplew.writeShort(0);
        writeCustomPlayerShopData(mplew, chr);
        return mplew.getPacket();
    }
    
    public static void writeCustomPlayerShopData(MaplePacketLittleEndianWriter mplew, MapleCharacter ips) {
        mplew.writeInt(ips.getPlayerShop().getCurrency());//item currency 431xxx
    ...
    public static final byte[] shopErrorMessage(final int error, final int type) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        //System.out.println("packet: " + mplew);
        mplew.writeShort(SendPacketOpcode.PLAYER_INTERACTION.getValue());
    ...
    public static final byte[] shopKick(final int error, final int type) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        //System.out.println("packet: " + mplew);
        mplew.writeShort(SendPacketOpcode.PLAYER_INTERACTION.getValue());
        mplew.write(GameConstants.GMS ? 18 : 0x0A);
    ...
    public static final byte[] shopItemUpdate(final MaplePlayerShop shop) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] getPlayerShopOwnerUpdate(MaplePlayerShopItem item, int position) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.PLAYER_INTERACTION.getValue());
        mplew.write(26);
    ...
    public static final byte[] shopVisitorLeave(final byte slot, int error) {
