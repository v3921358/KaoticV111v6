...
public class PetPacket {
    ...
    public static byte[] updatePet(final MaplePet pet, final Item item, final boolean active) {
        ...
        mplew.write(3);
        mplew.write(MapleInventoryType.CASH.getType());
    ...
    public static byte[] updatePet(final MaplePet pet, final Item item, final boolean active) {//fix bad packet
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.INVENTORY_OPERATION.getValue());
        mplew.write(0);
        mplew.write(2);
    ...
    public static final byte[] showPet(final MapleCharacter chr, final MaplePet pet, final boolean remove, final boolean hunger) {
        ...
        if (remove) {
            ...
            mplew.writeInt(chr.getMap().getFH(chr.getPosition()));
        }
