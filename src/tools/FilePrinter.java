...
public class FilePrinter {
    ...
    public static final String 
            ...
            LOG_SHOP = "interactions/Shops.txt",
    ...
    public static void print(final String name, final String s, boolean line) {
        print(name, s, line, true);
    }

    public static void print(final String name, final String s, boolean line, boolean print) {
