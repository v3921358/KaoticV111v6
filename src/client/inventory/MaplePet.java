...
public class MaplePet implements Serializable {
    ...
    public final void saveToDb() {
        try ( Connection con = DatabaseConnection.getPlayerConnection()) {
            ...
            ps.setString(1, name.length() > 13 ? "????" : name); // Set name
    ...
    public static final MaplePet createPet(final int itemid, final int uniqueid) {
        return createPet(itemid, MapleItemInformationProvider.getInstance().setRandomName(), 1, 0, 100, uniqueid, 0, (short) 0);
    }
