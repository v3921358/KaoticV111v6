...
public class ItemMakerHandler {
    ...
    private static Map<String, Integer> craftingEffects = new HashMap<String, Integer>();
    ...
    public static final void UseRecipe(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        if (c == null) {
            return;
        }
    ...
    public static final void MakeExtractor(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        if (c == null) {
            return;
        }
        if (chr == null || !chr.isAlive() || chr.getMap() == null || chr.hasBlockedInventory()) {
    ...
    public static final void UseBag(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        if (c == null) {
            return;
        }
        if (chr == null || !chr.isAlive() || chr.getMap() == null || chr.hasBlockedInventory()) {
    ...
    public static final void StartHarvest(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        if (c == null) {
            return;
        }
        ...
        if (lastTime + (5000) > System.currentTimeMillis()) {
            ...
            c.announce(CField.harvestMessage(reactor.getObjectId(), GameConstants.GMS ? 13 : 11)); //ok to harvest, gogo
            c.getPlayer().getMap().broadcastMessage(chr, CField.showHarvesting(chr.getId(), item.getItemId()), false);
        }
    }

    public static final void StopHarvest(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        //its ok if a hacker bypasses this as we do everything in the reactor anyway
        /*final MapleReactor reactor = c.getPlayer().getMap().getReactorByOid(slea.readInt());
    ...
    public static final void ProfessionInfo(final SeekableLittleEndianAccessor slea, final MapleClient c) { //so pointless
        if (c == null) {
            return;
        }
        try {
            ...
            c.announce(CWvsContext.professionInfo(asdf, level1, slea.readInt(), Math.max(0, 100 - ((level1 + 1) - c.getPlayer().getProfessionLevel(Integer.parseInt(asdf))) * 20)));
        } catch (NumberFormatException nfe) {
        } //idc
    }

    public static final void CraftEffect(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        if (c == null) {
            return;
        }
    ...
    public static final void CraftMake(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        if (chr.getMapId() != 910001000 && chr.getMap().getExtractorSize() <= 0) {
            return; //ardent mill
        }
    ...
    public static final void CraftComplete(final SeekableLittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        if (craftID == 92049000) { //disassembling
            ...
            chr.dropErrorMessage("fusion disabled");
            return;
        } else {
                        ...
                        if (Randomizer.nextInt(100) < i.right) {
                            ...
                            if (ce.needOpenItem) {
                                ...
                                if (mLevel == 1) {
                                    ...
                                    sa.put(ce, new SkillEntry(Integer.MAX_VALUE, (chr.getMasterLevel(craftID) - 1), SkillFactory.getDefaultSExpiry(ce)));
                                }
                            }
    ...
    public static final void UsePot(final SeekableLittleEndianAccessor slea, final MapleClient c) {
        final int itemid = slea.readInt();
    ...
    public static final void ClearPot(final SeekableLittleEndianAccessor slea, final MapleClient c) {
    ...
    public static final void FeedPot(final SeekableLittleEndianAccessor slea, final MapleClient c) {
        final int itemid = slea.readInt();
    ...
    public static final void CurePot(final SeekableLittleEndianAccessor slea, final MapleClient c) {
        final int itemid = slea.readInt();
    ...
    public static final void RewardPot(final SeekableLittleEndianAccessor slea, final MapleClient c) {
        final int index = slea.readInt() - 1;
