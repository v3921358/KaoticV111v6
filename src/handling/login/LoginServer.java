...
public class LoginServer {
    ...
    public static HashSet<String> getIPAuth() {
        return loginIPAuth;
    }
    ...
    public static final void run_startup_configurations() {
        ...
        //cfg.getSessionConfig().setSendBufferSize(256 * 1024);
        //cfg.getSessionConfig().setReceiveBufferSize(256 * 1024);
        //cfg.setDisconnectOnUnbind(true);
        cfg.getFilterChain().addLast("codec", new ProtocolCodecFilter(new MapleCodecFactory()));
        cfg.setReuseAddress(true);

        try {
            acceptor.bind(new InetSocketAddress(PORT), new MapleServerHandler(), cfg);
