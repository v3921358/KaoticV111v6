...
public class CharacterTransfer implements Externalizable {
    ...
    public int characterid, accountid, exp, fame, pvpLvl, pvpExp, pvpPoints,
            ...
            familyid, seniorid, junior1, junior2, currentrep, totalrep, battleshipHP, gachexp, guildContribution, totalWins, totalLosses, totallevel, str, dex, int_, luk, remainingSp, remainingAp;
    ...
    public int[] savedlocation, wishlist, rocks, regrocks, hyperrocks;
    ...
    public List<Integer> finishedAchievements = null, finishedQuests = null, famedcharacters = null, battledaccs = null, extendedSlots = null;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.totallevel = chr.getTotalLevel();
	...
	this.pvpPoints = chr.getBattlePoints();
        ...
        this.finishedQuests = chr.getFinishedQuestss();
        ...
        this.keymap = chr.getKeyLayout().getLayout(this.job);
